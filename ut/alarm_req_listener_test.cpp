...
public:
  AlarmReqListenerTest() :
    _alarm_pair_1(issuer, AlarmDef::SPROUT_HOMESTEAD_COMM_ERROR, AlarmDef::CRITICAL),
    _alarm_pair_2(issuer, AlarmDef::SPROUT_MEMCACHED_COMM_ERROR, AlarmDef::CRITICAL)
  {
