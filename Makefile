...
DEB_NAMES := clearwater-snmp-handler-bono clearwater-snmp-handler-sprout clearwater-snmp-handler-homestead clearwater-snmp-handler-cdiv clearwater-snmp-handler-memento-as clearwater-snmp-handler-memento

include build-infra/cw-deb.mk

.PHONY: deb
deb: sprout_handler.so bono_handler.so homestead_handler.so cdiv_handler.so memento_as_handler.so memento_handler.so deb-only
